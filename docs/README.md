...
| [`agents/gemini-hprcc-deployment.md`](agents/gemini-hprcc-deployment.md) | Gemini rbiocverse installation, hprcc custom controller, native resource metrics, durable Slurm launch, and monitoring | Scientific thresholds, credentials, or cluster-wide defaults |
