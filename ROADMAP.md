...
**Next task after this change lands:** **#229, prevent overplotting in
identifiability and critical-point figures**. Complete the remaining #229--#233
                              ...
                              sampling map         sampling map        regimes
                                      └──────────────────┼──────────────────┘
                                             ...
                                             #193 v5 runner adaptation;
                                                  manifest revealed; execute
                                                  only after runner merge
                                                         │
                                                         v
...
| [#220](https://github.com/drejom/landscapeR/issues/220) | Interpretation visual standards — independent time-course panel labels | complete on merge; then #228 |
...
| [#227](https://github.com/drejom/landscapeR/issues/227) | Interpretation visual standards — independent time-course clipping | complete |
...
| [#229](https://github.com/drejom/landscapeR/issues/229) | Interpretation visual standards — non-occluding evidence marks | active — next |
