# Stage 0 K=1 high-dimensional calibration assessment and publication (#191)
...
.k1_high_dimensional_artifact_files <- .k1_calibration_artifact_files

.k1_high_dimensional_artifact_messages <- function() list(
    incomplete = "high-dimensional calibration artifact is incomplete",
    invalid = "high-dimensional artifact manifest or files are invalid",
    derivatives = "high-dimensional artifact derivatives do not reproduce",
    atomic = "could not atomically publish high-dimensional artifact"
)

.k1_high_dimensional_display <- function(display) {
...
.verify_k1_high_dimensional_artifact <- function(artifact) {
    .k1_design_calibration_verify_artifact(
        artifact,
        .validate_k1_high_dimensional_assessment,
        plot_k1_high_dimensional_calibration,
        "landscapeR_k1_high_dimensional_map_data",
        .k1_high_dimensional_display,
        .k1_high_dimensional_artifact_files(),
        .k1_high_dimensional_artifact_messages()
    )
}
...
publish_k1_high_dimensional_calibration <- function(artifact_root, assessment) {
    .k1_calibration_publish_artifact(
        ...
        staging_prefix = ".k1-high-dimensional-tmp-",
        governed = .k1_high_dimensional_artifact_files(),
        messages = .k1_high_dimensional_artifact_messages()
    )
}
